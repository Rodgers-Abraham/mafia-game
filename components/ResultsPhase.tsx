  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="max-w-2xl w-full text-center animate-fadeIn">
        ...
        <p className="text-gray-600 tracking-widest text-xs spooky-title mb-8">
          -- THE TOWN HAS SPOKEN --
        </p>

        {lastDead ? (
          <div
            className="rounded-2xl border-2 p-8 mb-8 animate-slideUp"
            style={{
          ...
          >
            ...
            <div
              ...
              style={{ filter: `drop-shadow(0 0 20px ${roleColor})` }}
            >
              {revealed ? roleEmoji : '❓'}
            </div>

            <h2 className="text-4xl font-bold spooky-title mb-2 text-white">
              {lastDead.name}
            </h2>

            <p className="text-gray-500 spooky-title tracking-widest text-sm mb-4">
              HAS BEEN ELIMINATED
            </p>

            {/* Role reveal */}
            <div
              className="inline-block px-6 py-3 rounded-xl border mb-6"
              style={{
            ...
            >
              ...
              <p
                className="text-2xl font-bold spooky-title"
                style={{ color: roleColor, textShadow: `0 0 10px ${roleColor}` }}
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div
                ...
                style={{ borderColor: '#00A86B33', backgroundColor: 'rgba(0,168,107,0.1)' }}
              >
                <p className="text-gray-500 text-xs spooky-title tracking-widest mb-1">STILL ALIVE</p>
                <p className="text-3xl font-bold spooky-title" style={{ color: '#00A86B' }}>
                  {room.players.filter(p => p.isAlive).length}
                </p>
              </div>
              <div
                className="rounded-xl p-4 border"
                style={{ borderColor: '#8B000033', backgroundColor: 'rgba(139,0,0,0.1)' }}
              >
                <p className="text-gray-500 text-xs spooky-title tracking-widest mb-1">DECEASED</p>
                <p className="text-3xl font-bold spooky-title" style={{ color: '#8B0000' }}>
                  {room.players.filter(p => !p.isAlive).length}
                </p>
              </div>
            </div>
          ...
          >
            ...
            <p className="text-xl text-gray-400 spooky-title tracking-widest">
