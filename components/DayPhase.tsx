    ...
    <div className="min-h-screen p-6 md:p-8 day-bg">
      <div className="max-w-6xl mx-auto animate-fadeIn">
        ...
        <div className="text-center mb-8">
          ...
          <h1
            ...
            style={{
              fontSize: '3.5rem',
              color: '#c8a04a',
              textShadow: '0 0 30px rgba(200,160,74,0.8)',
            }}
          >
            DAY PHASE
          </h1>
        ...
        {room.players.some((p) => !p.isAlive) && (
          <div
            className="rounded-xl border p-5 mb-8 animate-slideUp text-center"
            style={{
          ...
          >
            ...
            <p className="text-gray-300 text-lg">
              {lastEliminated
                ? `${lastEliminated.name} was found dead this morning.`
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            <div
              ...
              style={{
                height: '520px',
                borderColor: '#3d002044',
                backgroundColor: 'rgba(0,0,0,0.6)',
              }}
            >
              {/* Chat header */}
              <div
                className="px-4 py-3 border-b spooky-title tracking-widest text-xs text-gray-500"
                style={{ borderColor: '#3d002033' }}
              >
                -- TOWN DISCUSSION --
              </div>
                ...
                {messages.length === 0 && (
                  <div className="h-full flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-gray-600 spooky-title tracking-widest text-sm">
                ...
                {messages.map((msg: ChatMessage, idx: number) => {
                  ...
                  return (
                    <div key={idx} className="flex items-start gap-3 animate-fadeIn">
                      ...
                      <div>
                        <span
                          className="font-semibold text-sm spooky-title"
                          style={{ color: '#c8a04a' }}
                        >
                          {msg.playerName}
                        </span>
              ...
              >
                <input
                  ...
                  style={{
                    ...
                    border: '1px solid #3d002044',
                  }}
                />
                <button
                  type="submit"
                  className="px-4 py-2 rounded-lg font-semibold spooky-title tracking-wider text-sm transition-all hover:scale-105"
                  style={{ backgroundColor: '#8B4513', border: '1px solid #c8a04a44' }}
                >
                  SPEAK
                </button>
              </form>
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div
              ...
              style={{
                borderColor: isUrgent ? '#8B000066' : '#3d002044',
                backgroundColor: isUrgent ? 'rgba(139,0,0,0.15)' : 'rgba(0,0,0,0.5)',
                boxShadow: isUrgent ? '0 0 20px rgba(139,0,0,0.3)' : 'none',
              }}
            >
              <p className="spooky-title tracking-widest text-xs text-gray-500 mb-2">TIME REMAINING</p>
              <div
                className={`text-4xl font-bold spooky-title mb-1 ${isUrgent ? 'animate-pulse' : ''}`}
                style={{ color: isUrgent ? '#DC143C' : '#c8a04a' }}
              >
                {minutes}:{seconds}
              </div>
              <p className="text-gray-600 text-xs spooky-title tracking-widest">
                {isUrgent ? 'VOTING IMMINENT' : 'UNTIL VOTING'}
              </p>
              {/* Progress bar */}
              <div className="mt-3 h-1 bg-gray-900 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: isUrgent ? '#DC143C' : '#c8a04a',
                  }}
                />
              </div>
            </div>
            ...
            >
              <p className="spooky-title tracking-widest text-xs text-gray-500 mb-3">
                SURVIVORS ({room.players.filter(p => p.isAlive).length})
              </p>
              ...
              {room.players.some(p => !p.isAlive) && (
                <div className="mt-3 pt-3 border-t" style={{ borderColor: '#3d002033' }}>
                  <p className="spooky-title tracking-widest text-xs text-gray-700 mb-2">
                    DECEASED ({room.players.filter(p => !p.isAlive).length})
                  </p>
