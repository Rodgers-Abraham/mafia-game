    ...
    <div className="min-h-screen p-6 md:p-8">
      <div className="max-w-5xl mx-auto animate-fadeIn">
        ...
        <div className="flex justify-center mb-10">
          <div
            className={`px-8 py-4 rounded-xl border text-center transition-all duration-500 ${isUrgent ? 'animate-pulse' : ''}`}
            style={{
              borderColor: isUrgent ? '#DC143C88' : '#3d002044',
              backgroundColor: isUrgent ? 'rgba(220,20,60,0.15)' : 'rgba(0,0,0,0.5)',
              boxShadow: isUrgent ? '0 0 30px rgba(220,20,60,0.3)' : 'none',
              minWidth: '200px',
            }}
          >
            <p className="spooky-title tracking-widest text-xs text-gray-600 mb-1">TIME TO VOTE</p>
            <div
              className="text-5xl font-bold spooky-title"
              style={{ color: isUrgent ? '#DC143C' : '#aaa' }}
            >
            ...
            <div className="mt-2 h-1 bg-gray-900 rounded-full overflow-hidden">
              <div
                ...
                style={{
                  ...
                  backgroundColor: isUrgent ? '#DC143C' : '#555',
                }}
              />
            </div>
          </div>
          ...
          {alivePlayers.map((target, idx) => {
            ...
            return (
              ...
              >
                ...
                {target.role === 'Mayor' && (
                  <div className="text-yellow-400 text-xs mt-1 spooky-title">MAYOR: 2x VOTE</div>
                )}
                {isSelected && (
                  <div
                    className="text-xs mt-2 spooky-title tracking-wider animate-fadeIn"
                    style={{ color: '#DC143C' }}
                  >
                    SELECTED
                  </div>
        ...
        <div className="text-center">
          {!hasVoted ? (
            ...
            <div
              className="inline-flex flex-col items-center gap-3 px-10 py-6 rounded-xl border animate-fadeIn"
              style={{
            ...
            >
              ...
              <p
                className="text-xl font-bold spooky-title tracking-wider"
                style={{ color: '#00A86B' }}
              >
                VOTE RECORDED
              </p>
              <p className="text-gray-500 text-sm spooky-title tracking-widest">
              ...
              <div className="flex gap-1 mt-1">
                {[0, 1, 2].map(i => (
                  <div
                    key={i}
                    className="w-2 h-2 rounded-full bg-green-800 animate-pulse"
